// visual_capture — packaged form of plugins/visual_capture/host.js.
...
export const name = 'visual_capture'
...
const CAPTURE_TIMEOUT_MS = 120000
    ...
    ctx.tools.register(tokensTool)
    ctx.tools.register(a11yTool)
